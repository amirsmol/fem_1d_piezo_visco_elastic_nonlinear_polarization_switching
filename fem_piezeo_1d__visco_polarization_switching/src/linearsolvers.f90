...
!      real(iwp), dimension( :, : ), intent( in ) :: A   ! Assume the shape of A.
!      real(iwp), dimension( : ), intent( in ) ::  b     ! Assume the shape of b.
!      real(iwp), dimension( : ), intent( out ) :: x     ! Assume the shape of x.
!
